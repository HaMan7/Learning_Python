#Hauwa 
# Building a Guess Game where a user tries to guess the number that the computer will select from a random number 
#If the user gets the number correctly, he gets 2 points and an added trial 
#If he misses it, he loses a trial 
#The user has 3 trials at the beginging of the game
import random
